...
- **Stop cancels every run in flight**, not just the newest. Sending a second follow-up before the first finished used to leave the first one running with nothing able to reach it.
